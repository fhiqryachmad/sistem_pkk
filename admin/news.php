        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <a href="<?php echo $newsform; ?>?mode=tambah" type="button" class="btn btn-primary" >Tambah <?php echo $caption; ?></a>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
            <!--DATA TABLE-->
            <?php get_data_info("tb_berita", "id_berita", 
                array("id_berita", "id_pokja", "gambar", "judul"), "newsform.php", "id_berita"); ?>
            <!--/*DATA TABLE -->
            <!-- /*ISI KONTEN -->
          </div>
          <!-- /.card-body -->
