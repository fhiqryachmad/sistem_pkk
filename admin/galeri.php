...
<?php 
  $caption    = "GALERI Baru";
  $fileutama  = "galeri.php";
  $galeriform   = "galeriform.php";
?>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <a href="<?php echo $galeriform; ?>?mode=tambah" type="button" class="btn btn-primary" >Tambah <?php echo $caption; ?></a>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
            <!--DATA TABLE-->
            <?php get_data_info("tb_galeri", "id_galeri", 
                array("id_galeri", "id_pokja", "gambar", "judul"), $galeriform, "id_galeri"); ?>
            <!--/*DATA TABLE -->
            <!-- /*ISI KONTEN -->
          </div>
          <!-- /.card-body -->
