      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Pengaturan Data Admnistrator</h3>
          ...
          <div class="card-body">
            <!-- ISI KONTEN -->
            <!--DATA TABLE-->
            <?php get_data_info("tb_admin", "id", 
                  array("id", "username", "password", "hak_akses"), // tampikan field data
                  "adminform.php", "id"); ?>
            <!--/*DATA TABLE -->
            <!-- /*ISI KONTEN -->
          </div>
